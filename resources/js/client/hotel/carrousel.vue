      ...
      <div class="carousel-inner">
        ...
        >
          ...
          <div class="carousel-caption">
            ...
            <router-link :to="'/' + hotel_nom + '/aboutus'">
              <button 
                class="explore-btn" 
...
export default {
  ...
  async created() {
    ...
    try {
      const response = await axios.get(`/api/hotels/${this.hotel_nom}`);
      this.galerie = response.data.galerie || [];
      
      this.slides = [
        {
          image: this.galerie[0] || 'https://images.unsplash.com/photo-1573843981267-be1999ff37cd?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2074&q=80',
          title: 'Votre séjour, notre priorité !',
          subtitle: this.hotel_nom,
          description: 'Découvrez le luxe et le confort dans notre établissement d\'exception'
        },
        {
          image: this.galerie[1] || 'https://images.unsplash.com/photo-1510414842594-a61c69b5ae57?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80',
          title: 'Une expérience unique',
          subtitle: 'Chambres & Suites',
          description: 'Des espaces élégants conçus pour votre bien-être'
        },
        {
          image: this.galerie[2] || 'https://images.unsplash.com/photo-1590523741831-ab7e8b8f9c7f?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2074&q=80',
  ...
  methods: {
    startAutoplay() {
      this.autoplayInterval = setInterval(this.nextSlide, 5000); // 5 secondes
    },
    stopAutoplay() {
