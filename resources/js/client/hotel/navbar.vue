<template>
    <nav class="navbar navbar-expand-lg navbar-light bg-white">
        <div class="container-fluid">
            <a class="navbar-brand alliance-logo" :href="'/' + hotel_nom">{{ hotel_nom || 'Hôtel' }}</a>
            <button 
            ...
            <div class="collapse navbar-collapse" :class="{ 'show': isMenuOpen }" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a 
                            class="nav-link" 
                            :href="'/' + hotel_nom + '/galerie'"  
                            :class="{ active: activeLink === 'galerie' }" 
                            @click="setActiveLink('galerie')"
                        >
                            Galerie
                        </a>
                    </li>
                ...
                <div class="d-flex align-items-center">
                    <router-link class="profile-link" to="/profile" v-if="isAuthenticated">
                    ...
                    <div class="dropdown me-3 ml-4" @mouseleave="showDropdown = false">
                        ...
                        <ul class="dropdown-menu" :class="{ 'show': showDropdown }">
                            <li v-for="(lang, index) in languages" :key="index">
                                <button class="dropdown-item" @click="selectLanguage(lang)">
...
export default {
    ...
    mounted() {
        this.hotel_nom = this.$route.params.hotel_nom || 'default-hotel-name';
