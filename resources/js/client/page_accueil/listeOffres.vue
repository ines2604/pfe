<template>
    ...
    <div class="hotel-offers" style="margin-top: 80px">
        <section class="hero-section">
            <h1 class="main-title">Nos offres spéciales</h1>
        ...
        <div class="search-filter-section">
            <div class="filter-grid">
                ...
                <div class="select-wrapper">
                    ...
                    <select class="form-control" v-model="categoryFilter" :disabled="isLoading">
                ...
                <div class="select-wrapper">
                    <i class="fas fa-filter filter-icon"></i>
                    <select class="form-control" v-model="priceFilter" :disabled="isLoading">
                ...
                <div class="select-wrapper">
                    <i class="fas fa-filter filter-icon"></i>
                    <select class="form-control" v-model="sortBy" :disabled="isLoading">
    ...
    computed: {
        filteredOffers() {
            ...
            if (this.categoryFilter) {
                result = result.filter(offer => offer.categorie === this.categoryFilter);
            }

            if (this.priceFilter) {
                if (this.priceFilter.includes('+')) {
                    const minPrice = parseFloat(this.priceFilter.replace('+', ''));
                    result = result.filter(offer => offer.prix >= minPrice);
                } else {
                    const [min, max] = this.priceFilter.split('-').map(Number);
                    result = result.filter(offer => offer.prix >= min && offer.prix <= max);
                }
            }
